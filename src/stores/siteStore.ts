...
import type { SiteConfig, SiteFontConfig, SiteCursorConfig } from '@/types';
...
function applySiteFont(font: SiteConfig['font']) {
  ...
  const selectors =
    'body, .MuiTypography-root, .MuiButton-root, .MuiInputBase-root, button, input, textarea, select';
